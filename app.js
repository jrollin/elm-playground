...
var author$project$PhotoGroove$selectPhoto = {data: '2.jpeg', description: 'ClickedPhoto'};
...
var author$project$PhotoGroove$initialModel = {
	...
	selectedUrl: author$project$PhotoGroove$selectPhoto.data
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('sizeChooser')
					]),
				A2(
					elm$core$List$map,
